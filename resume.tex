...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Alina}{Li Zhenzhen}
\address{3209, Lift 19, Hong Kong University of Science and Technology}
\mobile{(+86) 13668252780} 
%%% Social
\email{zhenzhenli820@gmail.com}
%\homepage{www.posquit0.com}
%\github{posquit0}
%\linkedin{posquit0}
%%% Optionals
\position{Data Science{\enskip\cdotp\enskip}High Dimensional Data Analysis}
